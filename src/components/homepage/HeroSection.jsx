    ...
    <section className="relative mt-10 h-[calc(100vh-2.5rem)] w-full overflow-hidden bg-black">
      ...
      <div className="relative z-10 flex h-full flex-col justify-end px-6 pb-20 md:px-10 md:pb-28">
        <div className="flex items-center gap-2 mb-4">
          ...
          <span className={`${antonFont.className} text-xs md:text-sm font-bold uppercase tracking-widest text-red-500`}>
            The_Origin_Drop // Live Now
          </span>
        </div>

        <h1 className={`${antonFont.className} font-black uppercase text-white  text-5xl sm:text-6xl md:text-7xl lg:text-8xl max-w-2xl`}>
          Wear Your
          <br />
          Story
        </h1>
        ...
        <Link href="/drop" className="mt-8 w-fit">
          <span className={`${antonFont.className} group inline-flex items-center gap-2 bg-red-600 hover:bg-white hover:text-black text-white font-bold uppercase text-sm tracking-widest px-6 py-3.5 transition-colors duration-200`}>
            Shop The Drop
